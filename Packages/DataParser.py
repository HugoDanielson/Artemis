...
def run_script():
    ...
    workbook = pd.read_excel("ExcelFiles/SUPBDATA.xlsx") #Extracts data from this excel
    ...
    for indx in range(len(workbook['Tipo'])):
        ...
        if DD < 47:
            ...
            bearing_data_long[str(tipo)] = RoughFace1, RoughFace2, RoughOuter1, RoughOuter2, RoughOuter3 , FaceFinish1, FaceFinish2 , FaceFinish3
        ...
        try:
            ...
            print('No Data Dump')
    pickle.dump(bearing_data,open("BearingData1.p","wb"))
    pickle.dump(bearing_data_long,open("BearingData2.p","wb"))
